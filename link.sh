...
rm $BASE/brand_demo/app/assets/images/rainbow_wave_long.jpg
...
ln -s $BASE/dmproadmap_branding_demo/app/assets/images/rainbow_wave_long.jpg $BASE/brand_demo/app/assets/images/rainbow_wave_long.jpg
